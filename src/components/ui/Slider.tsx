...
const Slider = () => {
  ...
  useEffect(() => {
    ...
    let position = 0;
    const speed = 2; // px per frame — adjust to taste
          ...
          {doubled.map((tech, i) => (
            <div
              ...
              className="flex flex-col items-center justify-center gap-2 w-20 h-20 md:w-32 md:h-32 shrink-0
                border border-[#8d8d8d] hover:border-[#afafaf] bg-[#aeaeae] hover:bg-[#cab89a]/80 dark:border-white/10 dark:bg-white/3
                dark:hover:border-[#c9a76f]/40 dark:hover:bg-[#c9a76f]/5
