    ...
    >
      ...
      <div className="p-6 flex flex-col gap-3">
        ...
        <div className="flex items-baseline justify-between gap-3">
          ...
          <span className="jetbrains-mono text-[10px] text-[#ebb626] tracking-[.15em] shrink-0">
        ...
        {/* Links */}
        <div className="flex items-center gap-4 mt-2 pt-4 border-t border-gray-800/10 dark:border-white/10">
          {project.githubURL && (
            <a
              href={project.githubURL}
              target="_blank"
              rel="noopener noreferrer"
              className="jetbrains-mono text-[10px] tracking-[.18em] uppercase text-black dark:text-white
                hover:text-[#c9a84c] dark:hover:text-[#ebb626] transition-colors
                flex items-center gap-1.5 relative
                after:absolute after:-bottom-0.5 after:left-0 after:h-px after:w-0
                after:bg-[#ebb626] after:transition-all after:duration-300 hover:after:w-full"
            >
              GitHub ↗
            </a>
          )}
