...
export const SEQUENCE: Omit<TerminalLine, "id">[] = [
  ...
  { type: "output", text: "location    : Kediri, East Java, ID", cls: "dim" },
  { type: "output", text: "location    : Bandung, West Java, ID", cls: "dim" },
  { type: "output", text: "email       : insoniacx@gmail.com", cls: "dim" },
  { type: "output", text: "github      : github.com/insoniacx", cls: "dim" },
  ...
  { type: "divider" },
  {
    type: "cmd",
    prompt: "~$",
    text: "send_message --to insoniacx@gmail.com",
    typed: true,
  },
